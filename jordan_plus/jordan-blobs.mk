...
PRODUCT_COPY_FILES += \
	...
	device/motorola/jordan_plus/prebuilt/etc/init.d/00baseband:system/etc/init.d/00baseband \
	...
	device/motorola/jordan_plus/prebuilt/etc/init.d/09mmcfix:system/etc/init.d/09mmcfix \
